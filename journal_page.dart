...
class _MyJournalState extends State<MyJournal> {
  ...
  _MyJournalState({required this.email, required this.happinessScale});
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  final file = File('assets/lotw.xlsx');
                  ...
                  final g_Journal = g_journal.toLowerCase();
                  ...
                  for (final row in sheet.rows) {
                    for (final cell in row) {
                      if (cell != null && cell.cellType == CellType.values[0] && cell.value != null) {
                        final cellValue = cell.value.toString().toLowerCase();
                        print("$g_Journal");
                        if (g_Journal.contains(cellValue)) {
                          foundMatch = true;
                          break;
                        }
                      }
