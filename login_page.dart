...
*                Jowaki Merani - Added condition to check for valid entry 
                  April 9th 2023 - 
                  Parveen Kaur- Added conditions to hash passwords enetered and then compare to database
\
                    ...
                    CircleAvatar(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () async {
                          ...
                          //convert the password into a hash of sha1
                          hashvalue = sha1.convert(data);
                          //debug
                          print(
                              "HASH: $hashvalue"); //determine the collection of the entry
                          //check if hashed value exists on the database
