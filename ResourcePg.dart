/*
* NAME OF CODE ARTIFACT - ResourcePg.dart
* BRIEF DESCRIPTION - - This is the main resource page
...
//The constructor called to display the resource page
class Resources extends StatefulWidget {
  String email;
  String happinessScale;
  //takes in an email and the happiness scale
    ...
    return Scaffold(
      body: ListView(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 15.0),
          //TabBar, so it displays the Types of resources
          TabBar(
          ...
          Container(
            ...
            child: TabBarView(
              controller: _tabController,
              children: [
                //call PRofessionalPage for first tab and Personal page for second tab
                ProfessionalPage(),
                PersonalPage(),
              ],
            ),
      ...
      //displaying the bottom bar of the application
