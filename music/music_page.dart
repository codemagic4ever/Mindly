...
class MyMusic extends StatefulWidget {
  ...
  MyMusic({required this.email, required this.happinessScale}) ;// constructor for log in page.

  @override
  _MyMusicState createState() =>
      _MyMusicState(email: "$email", happinessScale: "$happinessScale"); //creates login page.
}
