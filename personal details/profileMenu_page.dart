...
class SettingsPageUI extends StatefulWidget {
  ...
  SettingsPageUI({required this.email, required this.happinessScale}); // constructor
  @override
  _SettingsPageUIState createState() => _SettingsPageUIState(
      email: '${email}', happinessScale: '${happinessScale}'); // call another function with this constructor
}

class _SettingsPageUIState extends State<SettingsPageUI> {
  String email; // member var
  String happinessScale;
  _SettingsPageUIState({required this.email, required this.happinessScale}); // constructor
  @override
