...
class Profile_pg extends StatefulWidget {
  ...
  Profile_pg({required this.email, required this.password, required this.name, required this.happinessScale});

  @override
  //constructor
  _Profile_pgState createState() => _Profile_pgState(
      email: '$email', password: '${password}', name: '${name}', happinessScale: '${happinessScale}');
}
...
class _Profile_pgState extends State<Profile_pg> {
  ...
  //constructor
  _Profile_pgState(
      {required this.email, required this.password, required this.name, required this.happinessScale});
