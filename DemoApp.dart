...
class DemoApp extends StatefulWidget {
  ...
  DemoApp({required this.email, required this.happinessScale}); // constructor
  @override
  // ignore: library_private_types_in_public_api
  _DemoAppState createState() => _DemoAppState(
      email: '${email}',
      happ: ('${happinessScale}')); // add a constructor that takes a parameter
}
...
class _DemoAppState extends State<DemoApp> {
  ...
  _DemoAppState({required this.email, required this.happ}); //create events// constructor
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => DemoApp(
                              email: ('$email'),happinessScale: ('$happ')
                            )));
                    //functionality
